...
def save_checkpoint(cfg, epoch, trainable_list, optimizer, scheduler, logger, det_best=False, seg_best=False):
    save_state = {
        'epoch': epoch,
        'mcn_state': trainable_list[0].state_dict(),
        'gaze_s_state': trainable_list[1].state_dict(),
        'gaze_kd_state': trainable_list[2].state_dict(),
